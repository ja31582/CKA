...
>>>>>>> edd241819c14761ff610ee389393e84d0fcf2704
...
Porównaj manifest i remkę `kubectl get pv`
`PersistentVolumeReclaimPolicy: Retain` - retain jest w defaulcie
![alt text](image-9.png)
![alt text](image-11.png)
jeżeli twojklaster ma już SotrageClasss (longhorn lub coś innego), pvc bedzie zawsze otrzymywał pv od storage class; dla tego należy użyć przy tworzeniu pv i pvc `storageClassName: manual`
