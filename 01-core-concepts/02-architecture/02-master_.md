...
Wszystkie dane (deployment/pod/service/configMap/secret/role/rolebindings) przechowywane są w ETCD, co znaczy że jeżeli etcd  zostanie uszkodzony, to staracimy dane klastra, brak informacji o cluster state.
